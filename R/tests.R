...
checkNumericEquals <- function(ex, ac, tolerance = .Machine$double.eps ^ 0.5, msg=NULL)
{
...
checkNumericMatrixEquals <- function(ex, ac, tolerance = .Machine$double.eps ^ 0.5, msg=NULL)  
{
